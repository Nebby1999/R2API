``Note: Sections in code blocks are comments and should be removed from the finalized readme``
...
# R2API.SurfaceDefs - Behaviours added from Surfaces

This submodule allows you to add new components to characters based on what surface they're on. A modular way to how the game handles Lava damage.
